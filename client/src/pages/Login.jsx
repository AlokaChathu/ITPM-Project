  ...
  const validateForm = () => {
    ...
    if (state === "Sign Up") {
      ...
      if (accountType === 'Company') {
        fields = ['companyName', 'email', 'password', 'phone', 'address', 'industry', 'registrationNumber'];
      } else {
        fields = ['name', 'email', 'password', 'age', 'phone', 'address'];
      }
      ...
      fields.forEach(field => {
        ...
        switch (field) {
          ...
          case 'registrationNumber': value = registrationNumber; break;
    ...
    try {
      ...
      const payload =
        ...
        state === "Sign Up"
          ...
          ? accountType === 'Company'
            ? { companyName, email, password, phone, address, industry, registrationNumber, accountType }
            : { name, email, password, age, phone, address, accountType }
          : { email, password };
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      >
        ...
        <form onSubmit={onSubmitHandler} className="space-y-4">
          ...
          {state === "Sign Up" && accountType === 'Student' && (
            <div className="transform transition-all duration-200">
              <InputField
                Icon={User}
          ...
          {state === "Sign Up" && accountType === 'Company' && (
            <div className="transform transition-all duration-200">
              <InputField
                Icon={User}
            ...
            <>
              ...
              <div className="transform transition-all duration-200">
                <InputField
                  ...
                  error={getFieldError('registrationNumber', registrationNumber)}
