...
function Login() {
  ...
  const validateField = (field, value) => {
    switch (field) {
      case "name":
        return /^[A-Za-z\s]{5,20}$/.test(value);
      case "email":
  ...
  const getFieldError = (field, value) => {
    ...
    switch (field) {
      case "name":
        ...
        if (!/^[A-Za-z\s]{5,20}$/.test(value)) {
          return "Name must be 5-20 alphabetic characters";
        }
        return null;
      case "email":
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-600">
            {showRolePicker
              ? "Select whether you want to register as a Student or a Company"
              : state === "Sign Up"
        ...
        {showRolePicker ? (
          <div className="space-y-4">
            <button
              ...
              className="w-full p-4 rounded-xl border border-indigo-200 bg-white hover:bg-indigo-50 transition shadow-sm flex items-center justify-between"
            >
            ...
            <button
              ...
              className="w-full p-4 rounded-xl border border-emerald-200 bg-white hover:bg-emerald-50 transition shadow-sm flex items-center justify-between"
            >
              <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-full mt-2 py-3 rounded-xl border border-slate-300 text-slate-700 hover:bg-slate-50 transition"
            >
              Back to Login
            </button>
          </div>
