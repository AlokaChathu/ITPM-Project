                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border ${
                        ...
                        <span className={`h-1.5 w-1.5 rounded-full ${
                          val.status === 'Ready' ? 'bg-emerald-500' : val.status === 'In Review' ? 'bg-blue-500' : 'bg-amber-500'
                        }`}></span>
                        {val.status}
                      </span>
                    </td>
                ...
                <form onSubmit={handleEvaluateSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-slate-100">
                    ...
                    <div className="flex flex-col justify-end">
                      <label className={`flex items-center justify-between gap-3 p-3.5 border rounded-xl cursor-pointer transition-colors shadow-sm ${
                        formData.isEligible ? 'bg-emerald-50 border-emerald-500' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
                      }`}>
                        <div>
