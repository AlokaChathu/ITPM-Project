...
export const register = async (req, res) => {
  ...
  const { name, email, password, age, phone, address, accountType, companyName, industry, registrationNumber } = req.body;

  console.log('Registration request:', { name, email, password: !!password, age, phone, address, accountType, companyName, industry, registrationNumber });



  try {

    // Common validation for both Student and Company
    if (!email || !password) {
    ...
    if (accountType === 'Company') {
      ...
      if (!companyName || !industry || !registrationNumber || !phone || !address) {
        return res.json({ success: false, message: "Missing company details" });
      }
      userData = {
        name: companyName,
        email,
      ...
      // Student registration fields (default)
